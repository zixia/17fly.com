...
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商
	...
	$dbhost = getenv('FLY17_MYSQL_HOST');	// 数据库服务器
	$dbuser = getenv('FLY17_MYSQL_USER');	// 数据库用户名
	$dbpw   = getenv('FLY17_MYSQL_PASS');	// 数据库密码
	$dbname = '17fly';			// 数据库名
...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'admin@17fly.net';		// 系统管理员 Email
...
define('UC_DBHOST', getenv('FLY17_MYSQL_HOST'));
define('UC_DBUSER', getenv('FLY17_MYSQL_USER'));
define('UC_DBPW', getenv('FLY17_MYSQL_PASS'));
define('UC_DBNAME', '17fly');

define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`17fly`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'B9Hf75qcIeCby1aff261gbZ7UfCdk2Mc93E9oexcr0T1td86B303baP4B9has0Fd');
define('UC_API', 'http://17fly.net/center');
define('UC_CHARSET', 'utf-8');
define('UC_IP', '211.99.222.62');
define('UC_APPID', '6');
define('UC_PPP', '20');
