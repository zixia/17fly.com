...
EOT;
		...
		if($uchomeopen) {
			...
			showsetting('settings_uc_home_show', array('settingsnew[uc][homeshow]', array(
				$lang['settings_uc_home_avatarshow'],
				$lang['settings_uc_home_viewproshow'],
				$lang['settings_uc_home_adshow'])), $settings['uc']['homeshow'], 'binmcheckbox');
		} else {
	...
	if($operation == 'uchome') {
		...
		$settingsnew['uc']['homeshow'] = bindec(intval($settingsnew['uc']['homeshow'][4]).intval($settingsnew['uc']['homeshow'][3]).intval($settingsnew['uc']['homeshow'][2]).intval($settingsnew['uc']['homeshow'][1]));
		$settingsnew['uc'] = addslashes(serialize($settingsnew['uc']));
	...
	if($updatecache) {
		...
		if((isset($settingsnew['smthumb']) && $settingsnew['smthumb'] != $settings['smthumb']) || (isset($settingsnew['smcols']) && $settingsnew['smcols'] != $settings['smcols']) || (isset($settingsnew['smrows']) && $settingsnew['smrows'] != $settings['smrows'])) {
			updatecache(array('smilies_display', 'smilies_js'));
		}
