...
/*
	...
	$Id: network_share.php 10322 2008-11-28 09:44:18Z liguode $
*/
...
if($count) {
	$query = $_SGLOBAL['db']->query("SELECT * FROM ".tname('share')." FORCE INDEX (dateline) WHERE $wheresql ORDER BY dateline DESC LIMIT $start,$perpage");
