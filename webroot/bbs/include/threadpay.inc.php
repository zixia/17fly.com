...
/*
	...
	$Id: threadpay.inc.php 16688 2008-11-14 06:41:07Z cnteacher $
*/
...
$thread['endtime'] = $maxchargespan ? dgmdate("$dateformat $timeformat", $timestamp + $maxchargespan * 3600 + $timeoffset * 3600) : 0;
